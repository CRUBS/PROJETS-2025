...
class callibrationForward(Node):
    ...
    """
    def __init__(self):
        super().__init__('move_forward_2sec')
        ...
        self.nbMaxCountCallback = int(4/self.frequency)  # marche avant pendant 2 sec, puis stop
    ...
    def timer_callbacks(self):
        ...
        self.get_logger().info(f"Nombre de callback : {self.callbackCount} / vitesse : {cmd_vel.linear.x}")
